...
export default {
  ...
  'play.credit.sheet.title': '需要提示？',
  'play.credit.sheet.balance': '你有 {n} 个提示',
  'play.credit.sheet.buyStarter': '购买入门包（150 积分）',
  'play.credit.sheet.bestValue': '最划算',
  'play.credit.sheet.watchAd': '看广告（+1 积分）',
  'play.credit.sheet.close': '关闭',
  'play.gift.today': '今日礼物：{n}',
  'home.gift.label': '每日礼物',
  'home.gift.subtitle': '每天免费金币',
  'gift.claim.title': '每日礼物',
  'gift.claim.amount': '+{n} 金币',
  'gift.claim.cta': '打开礼物',
  'gift.info.title': '今日礼物',
  'gift.info.today': '今天：{n} 金币',
  'gift.info.streak': '连续第 {n} 天',
  'gift.info.lifetime': '礼物金币累计：{n}',
  'gift.info.how': '10 枚金币可用灯泡显示一个字母。',
  'gift.info.unclaimed': '打开今天的礼物即可领取金币。',
  'gift.close': '关闭',
};
