...
export default {
  ...
  'settings.dev.wordMaster.subtitle': 'Level complete · time & star word',
  'settings.dev.streaksSparks': 'Streaks & Sparks',
  'settings.dev.streaksSparks.subtitle': 'Fire streak multiplier',
  'settings.dev.brainPower': 'Brain Power',
  'settings.dev.brainPower.subtitle': 'Chapter milestone · capacity bar',
  ...
  'intermission.brainPower.headline': 'Chapter Milestone',
