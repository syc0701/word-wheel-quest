...
export default {
  ...
  'play.error.noCredits': 'No letter credits left. Get more in the Shop or watch an ad.',
  ...
  'shop.alert.synced.title': 'Purchases synced',
  'shop.alert.synced.body': 'Your account coins and credits are up to date on this device.',
  'shop.alert.syncFailed.title': 'Could not sync',
  'shop.alert.syncFailed.body': 'Check your connection and try again.',
  'shop.alert.syncSignIn.title': 'Sign in to sync purchases',
  'shop.alert.syncSignIn.body': 'Coins and credits are consumable, so they cannot be restored with your Apple ID. Sign in to load them from your account on this device.',
  'shop.offeringHint': 'Offering `{id}` · App Store prices.',
  'shop.restore': 'Restore purchases',
  'shop.restore.ios': 'Sync shop purchases',
  'shop.restore.subtitleIos': 'Coins and credits are one-time. Sign in to load them from your account.',
  ...
  'complete.levelComplete': 'Level {n} Complete',
  ...
  'home.gift.label': 'Daily gift',
  'home.gift.subtitle': 'Free coins every day',
  'play.letter.show': 'Show 1 letter',
  'play.letter.needWord.title': 'Select a word',
  'play.letter.needWord.body': 'Choose a word first. The eye shows its first hidden letter.',
  'play.letter.failed.title': 'Could not reveal a letter',
  'play.letter.failed.body': 'Try again in a moment.',
  'play.credit.chip': 'Letter credits',
  'play.credit.sheet.title': 'Need a Hint?',
  'play.credit.sheet.balance': 'You have {n} hints',
  'play.credit.sheet.buyStarter': 'Buy Starter Pack (150 credits)',
  'play.credit.sheet.bestValue': 'Best value',
  'play.credit.sheet.watchAd': 'Watch ad (+1 credit)',
  'play.credit.sheet.close': 'Close',
  'play.gift.today': "Today's gift: {n}",
  'gift.claim.title': 'Daily gift',
  'gift.claim.amount': '+{n} coins',
  'gift.claim.why': 'For opening the app today.',
  'gift.claim.whyStreak': 'You came back again, so this one is bigger.',
  'gift.claim.cta': 'Open gift',
  'gift.info.title': "Today's gift",
  'gift.info.today': 'Today: {n} coins',
  'gift.info.streak': 'Day {n} in a row',
  'gift.info.lifetime': 'Gift coins so far: {n}',
  'gift.info.how': '10 coins reveal one letter with the lightbulb.',
  'gift.info.unclaimed': "Open today's gift to collect coins.",
  'gift.close': 'Close',
  'gift.claim.failed.title': 'Gift not saved',
  'gift.claim.failed.body': 'The coins did not reach your account. Try again.',
  'play.ad.failed.title': 'Ad reward not ready',
  'play.ad.failed.body': 'The credits did not arrive. Nothing was revealed.',
  'play.ad.loadFailed.title': 'Ad not available',
  'play.ad.loadFailed.body': 'The video could not start. Try again in a moment.',
  'onboarding.step.cellAd': 'This icon can show one hidden letter when a word still has empty cells.',
  'onboarding.step.credit': 'The top-right icon is where a short ad gives you 1 credit.',
  'onboarding.step.eye': 'You got 1 credit. Use it with the eye to show a letter.',
  'settings.dev.deviceId': 'Device ID',
  'settings.dev.deviceId.loading': 'Loading…',
