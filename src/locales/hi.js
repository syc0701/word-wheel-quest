...
export default {
  ...
  'play.credit.sheet.title': 'संकेत चाहिए?',
  'play.credit.sheet.balance': 'आपके पास {n} संकेत हैं',
  'play.credit.sheet.buyStarter': 'स्टार्टर पैक खरीदें (150 क्रेडिट)',
  'play.credit.sheet.bestValue': 'सबसे अच्छा मूल्य',
  'play.credit.sheet.watchAd': 'विज्ञापन देखें (+1 क्रेडिट)',
  'play.credit.sheet.close': 'बंद करें',
  'play.gift.today': 'आज का उपहार: {n}',
  'home.gift.label': 'रोज़ का उपहार',
  'home.gift.subtitle': 'हर दिन मुफ़्त सिक्के',
  'gift.claim.title': 'रोज़ का उपहार',
  'gift.claim.amount': '+{n} सिक्के',
  'gift.claim.cta': 'उपहार खोलें',
  'gift.info.title': 'आज का उपहार',
  'gift.info.today': 'आज: {n} सिक्के',
  'gift.info.streak': 'लगातार दिन {n}',
  'gift.info.lifetime': 'अब तक उपहार सिक्के: {n}',
  'gift.info.how': '10 सिक्कों से बल्ब एक अक्षर दिखाता है।',
  'gift.info.unclaimed': 'सिक्के पाने के लिए आज का उपहार खोलें।',
  'gift.close': 'बंद करें',
