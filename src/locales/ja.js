...
export default {
  ...
  'play.credit.sheet.title': 'ヒントが必要？',
  'play.credit.sheet.balance': 'ヒントが {n} 個あります',
  'play.credit.sheet.buyStarter': 'スターターパックを購入（150クレジット）',
  'play.credit.sheet.bestValue': 'お得',
  'play.credit.sheet.watchAd': '広告を見る（+1クレジット）',
  'play.credit.sheet.close': '閉じる',
  'play.gift.today': '今日のギフト: {n}',
  'home.gift.label': 'デイリーギフト',
  'home.gift.subtitle': '毎日無料コイン',
  'gift.claim.title': 'デイリーギフト',
  'gift.claim.amount': '+{n} コイン',
  'gift.claim.cta': 'ギフトを開ける',
  'gift.info.title': '今日のギフト',
  'gift.info.today': '今日: {n} コイン',
  'gift.info.streak': '{n} 日連続',
  'gift.info.lifetime': 'ギフトコイン合計: {n}',
  'gift.info.how': 'コイン10枚で電球から1文字を表示します。',
  'gift.info.unclaimed': '今日のギフトを開けてコインを受け取りましょう。',
  'gift.close': '閉じる',
};
