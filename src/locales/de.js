...
export default {
  ...
  'play.credit.sheet.title': 'Hinweis nötig?',
  'play.credit.sheet.balance': 'Du hast {n} Hinweise',
  'play.credit.sheet.buyStarter': 'Starter-Paket kaufen (150 Credits)',
  'play.credit.sheet.bestValue': 'Bestes Angebot',
  'play.credit.sheet.watchAd': 'Werbung ansehen (+1 Credit)',
  'play.credit.sheet.close': 'Schließen',
  'play.gift.today': 'Heutiges Geschenk: {n}',
  'home.gift.label': 'Tagesgeschenk',
  'home.gift.subtitle': 'Jeden Tag kostenlose Münzen',
  'gift.claim.title': 'Tagesgeschenk',
  'gift.claim.amount': '+{n} Münzen',
  'gift.claim.cta': 'Geschenk öffnen',
  'gift.info.title': 'Heutiges Geschenk',
  'gift.info.today': 'Heute: {n} Münzen',
  'gift.info.streak': 'Tag {n} in Folge',
  'gift.info.lifetime': 'Geschenkmünzen bisher: {n}',
  'gift.info.how': '10 Münzen zeigen einen Buchstaben mit der Glühbirne.',
  'gift.info.unclaimed': 'Öffne das heutige Geschenk, um Münzen zu sammeln.',
  'gift.close': 'Schließen',
