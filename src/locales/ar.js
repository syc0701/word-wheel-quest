...
export default {
  ...
  'play.credit.sheet.title': 'هل تحتاج تلميحًا؟',
  'play.credit.sheet.balance': 'لديك {n} تلميحات',
  'play.credit.sheet.buyStarter': 'اشترِ حزمة البداية (150 رصيدًا)',
  'play.credit.sheet.bestValue': 'أفضل قيمة',
  'play.credit.sheet.watchAd': 'شاهد إعلانًا (+1 رصيد)',
  'play.credit.sheet.close': 'إغلاق',
  'play.gift.today': 'هدية اليوم: {n}',
  'home.gift.label': 'هدية يومية',
  'home.gift.subtitle': 'عملات مجانية كل يوم',
  'gift.claim.title': 'هدية يومية',
  'gift.claim.amount': '+{n} عملات',
  'gift.claim.cta': 'افتح الهدية',
  'gift.info.title': 'هدية اليوم',
  'gift.info.today': 'اليوم: {n} عملات',
  'gift.info.streak': 'اليوم {n} على التوالي',
  'gift.info.lifetime': 'مجموع عملات الهدايا: {n}',
  'gift.info.how': '10 عملات تكشف حرفًا واحدًا بالمصباح.',
  'gift.info.unclaimed': 'افتح هدية اليوم لجمع العملات.',
  'gift.close': 'إغلاق',
