...
export default {
  ...
  'play.credit.sheet.title': '힌트가 필요하세요?',
  'play.credit.sheet.balance': '힌트 {n}개 보유',
  'play.credit.sheet.buyStarter': '스타터 팩 구매 (크레딧 150)',
  'play.credit.sheet.bestValue': '최고 혜택',
  'play.credit.sheet.watchAd': '광고 보기 (+1 크레딧)',
  'play.credit.sheet.close': '닫기',
  'play.gift.today': '오늘의 선물: {n}',
  'home.gift.label': '매일 선물',
  'home.gift.subtitle': '매일 무료 코인',
  'gift.claim.title': '매일 선물',
  'gift.claim.amount': '+{n} 코인',
  'gift.claim.cta': '선물 열기',
  'gift.info.title': '오늘의 선물',
  'gift.info.today': '오늘: {n} 코인',
  'gift.info.streak': '{n}일 연속',
  'gift.info.lifetime': '선물 코인 합계: {n}',
  'gift.info.how': '코인 10개로 전구를 사용해 글자 1개를 봅니다.',
  'gift.info.unclaimed': '오늘의 선물을 열어 코인을 받으세요.',
  'gift.close': '닫기',
